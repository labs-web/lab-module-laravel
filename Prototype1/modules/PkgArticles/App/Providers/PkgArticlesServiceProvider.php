...
namespace Modules\PkgArticles\App\Providers;

use Illuminate\Support\ServiceProvider;

class PkgArticlesServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../resources/views', 'pkg_articles');
    }
}
